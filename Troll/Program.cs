...
namespace FreeOnixV3
{
    class Program
    {
        ...
        {
            System.Diagnostics.Process[] processes = System.Diagnostics.Process.GetProcessesByName("Minecraft.Windows");
        ...
        {
            Console.Write(" [");
            Console.Write(option, System.Drawing.Color.MediumBlue);
            Console.Write("] ");
            Console.WriteLine(description, System.Drawing.Color.White);
        }

        public static void delayedWrite(string text, int delay)
        {
            Thread.Sleep(delay);
            Console.WriteLine(text, System.Drawing.Color.White);
        }
        ...
        startUP:
            ...
            Console.WriteLine(logo, System.Drawing.Color.Blue);
            ...
            if (input == "1")
            {
                ...
                //crackSpoof(logo); //leaving this in for those of you who decompiled it/look on github lol
                Thread.Sleep(1000);
                static void crackSpoof(string logo)
                {
                    Console.Clear();
                    for (int i = 0; i < 3; i++)
                    {
                    ...
                    Console.Clear();
                    Console.WriteLine(logo, System.Drawing.Color.Blue);
                    Console.WriteLine("!!IMPORTANT!!", System.Drawing.Color.Red);
                    ...
                    Console.Clear();
                    Console.WriteLine(logo, System.Drawing.Color.Blue);
                    Console.WriteLine("Onix Client has been cracked successfully!");
                    Console.WriteLine("Press any key to continue...");
                    Console.ReadKey();
                    OpenGame();
                }
                static void mainCrack(string logo)
                {
                    ...
                    Console.Write("File Deletion", System.Drawing.Color.Red);
                    Thread.Sleep(2000);
                    for (int i = 0; i < 5; i++)
                    {
                        Console.Clear();
                    ...
                    Console.WriteLine("cmljayByb2xsIHRpbWUhISEhISE=", System.Drawing.Color.Red);
                    Thread.Sleep(2000);
